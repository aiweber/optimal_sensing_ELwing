function [M K Ma Ia Q] = createODEfile_rotvect(a,b,E,G,nu,h,density,dampingfactor,phi,theta,psi,globalangle,N,dxi,thisODEfile)
%% 
...
% psi = flapping angle about z axis as function of time (in rad)
...
disp('creating ode and substituting variables')
fid = fopen(thisODEfile,'w');
fprintf(fid,['function dy = ' thisODEfile(1:end-2) '(t,y,v0,dv0,M,K,Ma,Ia,Q,cycles,frot)']);
fprintf(fid,'\n w =');
